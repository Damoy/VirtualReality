...
//    Model* planeModel = new Model("C:/Users/user/Downloads/dev/school/m2/RV/TP7/GeeBee2.x");
//    planeModel->setLight(ui->openGLWidget->light());
//    planeModel->setScale(0.5f);
//    double cubeX = ui->position_x_box->value();
//    double cubeY = ui->position_y_box->value();
//    double cubeZ = ui->position_z_box->value();
//    double cubeRotX = ui->rotation_pitch_box->value();
//    double cubeRotY = ui->rotation_yaw_box->value();
//    double cubeRotZ = ui->rotation_roll_box->value();
//    planeModel->setPosition(static_cast<GLfloat>(cubeX), static_cast<GLfloat>(cubeY), static_cast<float>(cubeZ));
//    planeModel->setOrientation(static_cast<GLfloat>(cubeRotX), static_cast<GLfloat>(cubeRotY), static_cast<float>(cubeRotZ));
//    ui->openGLWidget->addDrawable(planeModel);
//}
